...
Java_dev_openm3_hello_1world_DescriptiveWebViewActivity_nativeAttach(JNIEnv *env, jobject activity, jobject webview) {
...
extern "C" JNIEXPORT void JNICALL
Java_dev_openm3_hello_1world_DescriptiveWebViewActivity_nativeLoadApp(JNIEnv *env, jobject, jstring app_path) {
	if (!host_view.has_value().native_value()) {
...
extern "C" JNIEXPORT void JNICALL
Java_dev_openm3_hello_1world_DescriptiveWebViewActivity_nativeOnNavigationStarted(JNIEnv *env, jobject, jstring url) {
	enqueue_host_event(env, "webview_navigation_started", nullptr, url);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_openm3_hello_1world_DescriptiveWebViewActivity_nativeOnNavigationFinished(JNIEnv *env, jobject, jstring url) {
	enqueue_host_event(env, "webview_navigation_finished", nullptr, url);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_openm3_hello_1world_DescriptiveWebViewActivity_nativeOnLoadFailed(JNIEnv *env, jobject, jstring message, jstring url) {
	enqueue_host_event(env, "webview_load_failed", message, url);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_openm3_hello_1world_DescriptiveWebViewActivity_nativeOnMessage(JNIEnv *env, jobject, jstring message, jstring url) {
	enqueue_host_event(env, "webview_message", message, url);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_openm3_hello_1world_DescriptiveWebViewActivity_nativeDetach(JNIEnv *, jobject) {
	if (host_view.has_value().native_value()) {
